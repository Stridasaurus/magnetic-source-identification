...
- **Spherical dipoles ≈ random shell points.** The mean separation of two independent points on the shell is ≈ 4R/3 ≈ 11,100 km. The measured spherical dipole error is **~11,000 km** (median 10,977, RMSE 10,967). Forced off the interior and onto the shell, the constrained model's dipole predictions fall on the scale of random shell points (~4R/3) — it extracts essentially no usable dipole position information. interestingly, looking at the locations of the bad predictions we can see the geocentric hedge for experiment 3 and when we removed the possibility of a geocentric prediction we can see the asymmetrical degeneracy caused by the uneven sensor distribution across the globe.

<Figure size 1600x700 with 4 Axes><img width="1561" height="683" alt="image" src="https://github.com/user-attachments/assets/8726fead-8185-4141-bf00-c20c88f94ed8" />
